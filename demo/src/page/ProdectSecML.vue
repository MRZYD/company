<template lang="html">
  <div class="content">
          ...
          <div :class="['phase_box1 prd_box', tab == 1 ? 'hover' : '']">
            ...
            <div :class="['prd_box_app', type == 2 ? 'hover' : '']">
              ...
              <div class="right">
                ...
                <p class="right_describe font16">中国最专业的窗帘行业小程序商城，可以免费开一个属于自己的窗帘网络商城，可以免费发布商情，推广自己的窗帘店和产品</p>
              </div>
            </div>
          </div>
          <!-- 第二期 -->
    ...
    <div class="app_prd_con1">
      ...
      <div class="app_sec_box">
        ...
        <div :class="['app_box_fir', version == 1 ? 'hover' : '']">
          <h2>美帘</h2>
          <h4>开发周期：45个工作日</h4>
          <p>中国最专业的窗帘行业小程序商城，可以免费开一个属于自己的窗帘网络商城，可以免费发布商情，推广自己的窗帘店和产品</p>
    ...
    <div class="app_prd_con2">
      ...
      <ul>
        <li>
          <h3><span></span>商家入驻</h3>
          <p>商家提交入驻申请通过后可发布商品</p>
        </li>
        <li>
          <h3><span></span>商情发布</h3>
          <p>发布商情时可套用模板，添加、排版更方便</p>
        </li>
        <li>
          <h3><span></span>在线拍卖</h3>
          <p>发布自己的拍卖商品，设置拍卖时间，商品价高者得</p>
        </li>
        <li>
          <h3><span></span>账本记账</h3>
          <p>平台所有交易产生交易记录全部记录到账本中，欠账、赊账一目了然</p>
        </li>
      </ul>
    </div>
    <!--内容三-->
    ...
    <div class="prd_sec_con5 app_consec">
      <div class="width">
        ...
        <div class="cengdaoyou clearfix">
          <div class="left">
            <div class="ceng_logo">
              <img src="http://pd10b0don.bkt.clouddn.com/ML_logo.png" class="left" />
              <div class="left qugou">
                <p class="font18">美帘</p>
                <p class="font14">美帘，窗帘不仅仅是生意，更是社交</p>
              </div>
            </div>
            <div class="ceng_character font14">
              淮安袋鼠饰家网络科技有限公司，秉承着生意就是社交，让人脉圈从两边产生质变的初衷，开发了“踢TA”APP，并将APP与小程序打通，做到微信内的广泛传播。
            </div>
          </div>
...
export default {
  data() {
    return {
      ...
      appban: [
        { img1: "http://pd10b0don.bkt.clouddn.com/ML_1.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/ML_2.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/ML_3.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/ML_4.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/ML_5.jpg" }
      ],
      swiperOption: {
