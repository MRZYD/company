  ...
  <div class="content">
          ...
          <div :class="['phase_box1 prd_box', tab == 1 ? 'hover' : '']">
            ...
            <div :class="['prd_box_app', type == 2 ? 'hover' : '']">
              ...
              <div class="right">
                ...
                <p class="font36">博龙畜牧</p>
                <p class="right_time font14">开发周期：30个工作日</p>
                <p class="right_describe font16">全新布局的自适应企业官网，打通小程序端与网页端管理，内容实时同步</p>
              </div>
            </div>
          </div>
          <!-- 第二期 -->
    ...
    <div class="prd_sec_con2 app_consec">
      ...
      <div class="con2_module">
        <ul>
          <li>
            <p class="font18">自适应官网</p>
            <p class="font14">WEB端、移动端的自适应展示</p>
          </li>
          <li>
            <p class="font18">企业官网</p>
            <p class="font14">全方位企业形象展示，打造高端品牌形象</p>
          </li>
          <li>
            <p class="font18">表单提交</p>
            <p class="font14">免费资料申请表提交，积极拓展全方位销售渠道</p>
          </li>
          <li>
            <p class="font18">打通小程序</p>
            <p class="font14">全部功能适用于微信小程序</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="app_prd_con1">
      ...
      <div class="app_sec_box">
        ...
        <div :class="['app_box_fir', version == 1 ? 'hover' : '']">
          <h2>博龙畜牧</h2>
          <h4>开发周期：30个工作日</h4>
          <p>全新布局的自适应企业官网，打通小程序端与网页端管理，内容实时同步</p>
    ...
    <div class="app_prd_con2">
      ...
      <ul>
        <li>
          <h3><span></span>自适应官网</h3>
          <p>WEB端、移动端的自适应展示</p>
        </li>
        <li>
          <h3><span></span>企业官网</h3>
          <p>全方位企业形象展示，打造高端品牌形象</p>
        </li>
        <li>
          <h3><span></span>表单提交</h3>
          <p>免费资料申请表提交，积极拓展全方位销售渠道</p>
        </li>
        <li>
          <h3><span></span>打通小程序</h3>
          <p>全部功能适用于微信小程序</p>
        </li>
      </ul>
    </div>
    ...
    <div class="prd_sec_con5 app_consec">
      <div class="width">
        ...
        <div class="cengdaoyou clearfix">
          <div class="left">
            <div class="ceng_logo">
              <img src="http://pd10b0don.bkt.clouddn.com/BL_logo.png" class="left" />
              <div class="left qugou">
                <p class="font18">博龙畜牧</p>
                <p class="font14">博龙畜牧，中国养鸡自动化行业先行者</p>
              </div>
            </div>
            <div class="ceng_character font14">
              博龙公司成立于1992年，位于河南省鹤壁市山城区。经过二十多年的不懈努力，已经发展成为一家集肉种鸡饲养、种蛋供应、苗鸡孵化、产品回收为一体的大型现代化肉种鸡繁育企业，拥有六个全进全出的父母代肉种鸡场、一个大型孵化厂、一座饲料厂、一个畜牧机械公司以及实验场等。常年存栏父母代肉种鸡26万套，每年可以向社会提供种蛋及苗鸡2000余万枚（只）以及肉种鸡平养系列设备。
            </div>
          </div>
...
export default {
  data() {
    return {
      ...
      appban: [
        { img1: "http://pd10b0don.bkt.clouddn.com/BL_1.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/BL_2.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/BL_3.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/BL_4.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/BL_5.jpg" }
      ],
      swiperOption: {
