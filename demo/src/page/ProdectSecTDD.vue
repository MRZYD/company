  ...
  <div class="content">
          ...
          <div :class="['phase_box1 prd_box', tab == 1 ? 'hover' : '']">
            ...
            <div :class="['prd_box_app', type == 2 ? 'hover' : '']">
              ...
              <div class="right">
                ...
                <p class="font36">棠嘟嘟奢侈品短购</p>
                <p class="right_time font14">开发周期：60个工作日</p>
                <p class="right_describe font16">独特的短购模式，送/取货上门的优质服务，让你在使用奢侈品包包的同时享受优惠的价格，倡导理性消费的短购平台。</p>
              </div>
            </div>
          </div>
          <!-- 第二期 -->
    ...
    <div class="prd_sec_con2 app_consec">
      ...
      <div class="con2_module">
        <ul>
          <li>
            <p class="font18">短购下单</p>
            <p class="font14">根据不同的时间段来计算不同的短购价格并形成订单</p>
          </li>
          <li>
            <p class="font18">实名认证</p>
            <p class="font14">保证商品与押金的安全，需要用户进行实名认证并调用接口识别是否为实名</p>
          </li>
          <li>
            <p class="font18">押金退还</p>
            <p class="font14">短购结束后，根据商品情况退还押金</p>
          </li>
          <li>
            <p class="font18">评价系统</p>
            <p class="font14">对订单服务进行评价，并上传产品使用照片</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="app_prd_con1">
      ...
      <div class="app_sec_box">
        ...
        <div :class="['app_box_fir', version == 1 ? 'hover' : '']">
          <h2>棠嘟嘟奢侈品短购</h2>
          <h4>开发周期：60个工作日</h4>
          <p>独特的短购模式，送/取货上门的优质服务，让你在使用奢侈品包包的同时享受优惠的价格，倡导理性消费的短购平台。</p>
    ...
    <div class="app_prd_con2">
      ...
      <ul>
        <li>
          <h3><span></span>短购下单</h3>
          <p>根据不同的时间段来计算不同的短购价格并形成订单</p>
        </li>
        <li>
          <h3><span></span>实名认证</h3>
          <p>保证商品与押金的安全，需要用户进行实名认证并调用接口识别是否为实名</p>
        </li>
        <li>
          <h3><span></span>押金退还</h3>
          <p>短购结束后，根据商品情况退还押金</p>
        </li>
        <li>
          <h3><span></span>评价系统</h3>
          <p>对订单服务进行评价，并上传产品使用照片</p>
        </li>
      </ul>
    </div>
    <!--内容三-->
    ...
    <div class="prd_sec_con5 app_consec">
      <div class="width">
        ...
        <div class="cengdaoyou clearfix">
          <div class="left">
            <div class="ceng_logo">
              <img src="http://pd10b0don.bkt.clouddn.com/TDD_logo.png" class="left" />
              <div class="left qugou">
                <p class="font18">棠嘟嘟短购平台</p>
                <p class="font14">棠嘟嘟短购平台，精选包包，理性消费</p>
              </div>
            </div>
            <div class="ceng_character font14">
              立足于北京主打奢侈品包包短购的平台，满足广大白领女性对奢侈品包包的短期需求。
            </div>
          </div>
...
export default {
  data() {
    return {
      ...
      appban: [
        { img1: "http://pd10b0don.bkt.clouddn.com/TDD_1.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/TDD_2.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/TDD_3.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/TDD_4.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/TDD_5.jpg" }
      ],
      swiperOption: {
