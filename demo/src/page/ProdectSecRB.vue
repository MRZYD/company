  ...
  <div class="content">
          ...
          <div :class="['phase_box1 prd_box', tab == 1 ? 'hover' : '']">
            ...
            <div :class="['prd_box_pc', type == 1 ? 'hover' : '']">
              ...
              <div class="right">
                ...
                <p class="font36">日本恩田株式会社</p>
                <p class="right_time font14">开发周期：30个工作日</p>
                <p class="right_describe font16">公司产品销售，双语切换，对接多种支付方式，用户选择国内仓储发货可获得优惠减免。</p>
              </div>
            </div>
            <!-- 小程序 -->
    ...
    <div class="prd_sec_con2 app_consec">
      ...
      <div class="con2_module">
        <ul>
          <li>
            <p class="font18">商城系统</p>
            <p class="font14">完整的商城系统，实现完整的电商购物流程</p>
          </li>
          <li>
            <p class="font18">双语言切换</p>
            <p class="font14">页面可切换日语、英语显示，国际化的商品销售渠道</p>
          </li>
          <li>
            <p class="font18">多支付方式</p>
            <p class="font14">对接包括微信支付、支付宝支付、APPLE PAY等六种支付方式</p>
          </li>
          <li>
            <p class="font18">订单推送邮件</p>
            <p class="font14">用户下单成功后自动通过邮件推送订单内容到仓储负责人</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="app_prd_con1">
      ...
      <div class="app_sec_box">
        ...
        <div :class="['app_box_fir', version == 1 ? 'hover' : '']">
          <h2>日本恩田株式会社</h2>
          <h4>开发周期：30个工作日</h4>
          <p>公司产品销售，双语切换，对接多种支付方式，用户选择国内仓储发货可获得优惠减免。</p>
    ...
    <div class="app_prd_con2">
      ...
      <ul>
        <li>
          <h3><span></span>商城系统</h3>
          <p>完整的商城系统，实现完整的电商购物流程</p>
        </li>
        <li>
          <h3><span></span>双语言切换</h3>
          <p>页面可切换日语、英语显示，国际化的商品销售渠道</p>
        </li>
        <li>
          <h3><span></span>多支付方式</h3>
          <p>对接包括微信支付、支付宝支付、APPLE PAY等六种支付方式</p>
        </li>
        <li>
          <h3><span></span>订单推送邮件</h3>
          <p>用户下单成功后自动通过邮件推送订单内容到仓储负责人</p>
        </li>
      </ul>
    </div>
    <!--内容三-->
    ...
    <div class="prd_sec_con5 app_consec">
      <div class="width">
        ...
        <div class="cengdaoyou clearfix">
          <div class="left">
            <div class="ceng_logo">
              <img src="http://pd10b0don.bkt.clouddn.com/RB_logo.png" class="left" />
              <div class="left qugou">
                <p class="font18">日本恩田株式会社</p>
                <p class="font14">健康食品、美容食品、化妆品销售平台，主打产品销往欧亚各国</p>
              </div>
            </div>
            <div class="ceng_character font14">
              日本恩田株式会社,健康食品、美容食品、化妆品销售平台，主打产品销往欧亚各国,公司产品销售，双语切换，对接多种支付方式，用户选择国内仓储发货可获得优惠减免。
            </div>
          </div>
...
export default {
  data() {
    return {
      pcban: [
        { img1: "http://pd10b0don.bkt.clouddn.com/RB_PC1.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/RB_PC2.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/RB_PC3.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/RB_PC4.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/RB_PC5.jpg" }
      ],
      appban: [
        { img1: "http://pd10b0don.bkt.clouddn.com/RB_APP1.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/RB_APP2.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/RB_APP3.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/RB_APP4.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/RB_APP5.jpg" }
      ],
      swiperOption: {
