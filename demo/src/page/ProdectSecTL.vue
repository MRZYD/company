  ...
  <div class="content">
          ...
          <div :class="['phase_box1 prd_box', tab == 1 ? 'hover' : '']">
            ...
            <div :class="['prd_box_app', type == 2 ? 'hover' : '']">
              ...
              <div class="right">
                ...
                <p class="font36">铁路培训答题</p>
                <p class="right_time font14">开发周期：50个工作日</p>
                <p class="right_describe font16">铁路部门为方便学员及时掌握所学知识开发的在线答题小程序，拥有即时匹配对战，班级发起对战，好友对战，知识掌握向性图，错题库等功能</p>
              </div>
            </div>
          </div>
          <!-- 第二期 -->
    ...
    <div class="prd_sec_con2 app_consec">
      ...
      <div class="con2_module">
        <ul>
          <li>
            <p class="font18">班级对战</p>
            <p class="font14">多人实时在线答题对战，掌握知识的同时收获快乐</p>
          </li>
          <li>
            <p class="font18">匹配答题</p>
            <p class="font14">实时在线匹配对手进行一局对战，看谁更快更强</p>
          </li>
          <li>
            <p class="font18">好友对战</p>
            <p class="font14">随时邀请他来一局，论论知识长短</p>
          </li>
          <li>
            <p class="font18">排行榜</p>
            <p class="font14">看看你的段位能排到哪一位</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="app_prd_con1">
      ...
      <div class="app_sec_box">
        ...
        <div :class="['app_box_fir', version == 1 ? 'hover' : '']">
          <h2>铁路培训答题</h2>
          <h4>开发周期：50个工作日</h4>
          <p>铁路部门为方便学员及时掌握所学知识开发的在线答题小程序，拥有即时匹配对战，班级发起对战，好友对战，知识掌握向性图，错题库等功能</p>
    ...
    <div class="app_prd_con2">
      ...
      <ul>
        <li>
          <h3><span></span>班级对战</h3>
          <p>多人实时在线答题对战，掌握知识的同时收获快乐</p>
        </li>
        <li>
          <h3><span></span>匹配答题</h3>
          <p>实时在线匹配对手进行一局对战，看谁更快更强</p>
        </li>
        <li>
          <h3><span></span>好友对战</h3>
          <p>随时邀请他来一局，论论知识长短</p>
        </li>
        <li>
          <h3><span></span>排行榜</h3>
    ...
    <div class="prd_sec_con5 app_consec">
      <div class="width">
        ...
        <div class="cengdaoyou clearfix">
          <div class="left">
            <div class="ceng_logo">
              <img src="http://pd10b0don.bkt.clouddn.com/TL_logo.png" class="left" />
              <div class="left qugou">
                <p class="font18">铁路培训答题</p>
                <p class="font14">铁路培训答题，为每位铁路工作者的学习成长保驾护航</p>
              </div>
            </div>
            <div class="ceng_character font14">
              中国铁路总公司（简称“中国铁路”）是经国务院批准，依据《中华人民共和国全民所有制工业企业法》设立，由中央管理的国有独资企业，注册资金10360亿元。
...
export default {
  data() {
    return {
      ...
      appban: [
        { img1: "http://pd10b0don.bkt.clouddn.com/TL_1.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/TL_2.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/TL_3.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/TL_4.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/TL_5.jpg" }
      ],
      swiperOption: {
