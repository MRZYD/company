  ...
  <div class="content">
          ...
          <div :class="['phase_box1 prd_box', tab == 1 ? 'hover' : '']">
            ...
            <div :class="['prd_box_app', type == 2 ? 'hover' : '']">
              ...
              <div class="right">
                ...
                <p class="font36">壹号便利购</p>
                <p class="right_time font14">开发周期：35个工作日</p>
                <p class="right_describe font16">人脸上传及识别，扫一扫把商品添加到购物车，消费发放优惠券</p>
              </div>
            </div>
          </div>
          <!-- 第二期 -->
    ...
    <div class="prd_sec_con2 app_consec">
      ...
      <div class="con2_module">
        <ul>
          <li>
            <p class="font18">人脸上传</p>
            <p class="font14">对接百度的人脸识别系统，实时上传人脸照片，实现人脸识别</p>
          </li>
          <li>
            <p class="font18">扫一扫识别</p>
            <p class="font14">扫一扫识别商品码，并添加到购物车内</p>
          </li>
          <li>
            <p class="font18">优惠券发放</p>
            <p class="font14">新用户赠送全平台通用优惠券，购物成功还有满减券发放</p>
          </li>
          <li>
            <p class="font18">充值消费</p>
            <p class="font14">充值可享受充值奖励，充值金额可在消费时选择使用</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="app_prd_con1">
      ...
      <div class="app_sec_box">
        ...
        <div :class="['app_box_fir', version == 1 ? 'hover' : '']">
          <h2>壹号便利购</h2>
          <h4>开发周期：35个工作日</h4>
          <p>人脸上传及识别，扫一扫把商品添加到购物车，消费发放优惠券</p>
    ...
    <div class="app_prd_con2">
      ...
      <ul>
        <li>
          <h3><span></span>人脸上传</h3>
          <p>对接百度的人脸识别系统，实时上传人脸照片，实现人脸识别</p>
        </li>
        <li>
          <h3><span></span>扫一扫识别</h3>
          <p>扫一扫识别商品码，并添加到购物车内</p>
        </li>
        <li>
          <h3><span></span>优惠券发放</h3>
          <p>新用户赠送全平台通用优惠券，购物成功还有满减券发放</p>
        </li>
        <li>
          <h3><span></span>充值消费</h3>
          <p>充值可享受充值奖励，充值金额可在消费时选择使用</p>
        </li>
      </ul>
    </div>
    <!--内容三-->
    ...
    <div class="prd_sec_con5 app_consec">
      <div class="width">
        ...
        <div class="cengdaoyou clearfix">
          <div class="left">
            <div class="ceng_logo">
              <img src="http://pd10b0don.bkt.clouddn.com/YH_logo.png" class="left" />
              <div class="left qugou">
                <p class="font18">壹号便利购</p>
                <p class="font14">壹号便利购，打通线上线下的智能购物平台</p>
              </div>
            </div>
            <div class="ceng_character font14">
              壹号便利购专注于互联网餐饮及零售行业软件开发，投资并于线下开放了三家无人店铺并对接小程序进行管理及销售。
            </div>
          </div>
...
export default {
  data () {
    return {
      ...
      appban: [
        {img1: 'http://pd10b0don.bkt.clouddn.com/YH_1.jpg'},
        {img1: 'http://pd10b0don.bkt.clouddn.com/YH_2.jpg'},
        {img1: 'http://pd10b0don.bkt.clouddn.com/YH_3.jpg'},
        {img1: 'http://pd10b0don.bkt.clouddn.com/YH_4.jpg'},
        {img1: 'http://pd10b0don.bkt.clouddn.com/YH_5.jpg'}
      ],
      swiperOption: {
