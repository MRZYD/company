  ...
  <div class="content">
          ...
          <div :class="['phase_box1 prd_box', tab == 1 ? 'hover' : '']">
            ...
            <div :class="['prd_box_app', type == 2 ? 'hover' : '']">
              ...
              <div class="right">
                ...
                <p class="font36">百会微题库</p>
                <p class="right_time font14">开发周期：45个工作日</p>
                <p class="right_describe font16">百会考试微题库，提供在线考试题库、在线做题、在线模拟测验服务，为考生充分利用碎片化的时间学习提供技术支持</p>
              </div>
            </div>
          </div>
          <!-- 第二期 -->
    ...
    <div class="prd_sec_con2 app_consec">
      ...
      <div class="con2_module">
        <ul>
          <li>
            <p class="font18">顺序答题</p>
            <p class="font14">通过历年的真命题一遍一遍的进行测试</p>
          </li>
          <li>
            <p class="font18">中医考题</p>
            <p class="font14">通过现今网络技术与中医结合，让更多人了解中医的知识</p>
          </li>
          <li>
            <p class="font18">模拟答题</p>
            <p class="font14">通过不断模拟答题的来掌握熟记知识</p>
          </li>
          <li>
            <p class="font18">通关模式</p>
            <p class="font14">每次的努力都是需要循循渐进</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="app_prd_con1">
      ...
      <div class="app_sec_box">
        ...
        <div :class="['app_box_fir', version == 1 ? 'hover' : '']">
          <h2>消费者调查测评</h2>
          <h4>开发周期：30个工作日</h4>
          <p>《中国消费者报》为服务广大消费者，提供的专项调查测评小程序，包括问卷调查、答题奖励、奖励提现等功能</p>
    ...
    <div class="app_prd_con2">
      ...
      <ul>
        <li>
          <h3><span></span>顺序答题</h3>
          <p>通过历年的真命题一遍一遍的进行测试</p>
        </li>
        <li>
          <h3><span></span>中医考题</h3>
          <p>通过现今网络技术与中医结合，让更多人了解中医的知识</p>
        </li>
        <li>
          <h3><span></span>模拟答题</h3>
          <p>通过不断模拟答题的来掌握熟记知识</p>
        </li>
        <li>
          <h3><span></span>通关模式</h3>
          <p>每次的努力都是需要循循渐进</p>
        </li>
      </ul>
    </div>
    ...
    <div class="prd_sec_con5 app_consec">
      <div class="width">
        ...
        <div class="cengdaoyou clearfix">
          <div class="left">
            <div class="ceng_logo">
              <img src="http://pd10b0don.bkt.clouddn.com/logo12-2.png" class="left" />
              <div class="left qugou">
                <p class="font18">百会考试微题库</p>
                <p class="font14">百会考试微题库，医学考研必备题库</p>
              </div>
            </div>
            <div class="ceng_character font14">
              北京大都百会信息咨询有限公司，承办针灸中国网、针会天下交流群，一根根针，会天下朋友！荟萃中医、针灸以及健康养生的相关专业知识及科普知识。推荐好用的养生方法及养生产品。
            </div>
          </div>
...
export default {
  data() {
    return {
      ...
      appban: [
        { img1: "http://pd10b0don.bkt.clouddn.com/PX_1.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/PX_2.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/PX_3.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/PX_4.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/PX_5.jpg" }
      ],
      swiperOption: {
