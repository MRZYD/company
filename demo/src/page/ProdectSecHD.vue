  ...
  <div class="content">
          ...
          <div :class="['phase_box1 prd_box', tab == 1 ? 'hover' : '']">
            ...
            <div :class="['prd_box_app', type == 2 ? 'hover' : '']">
              ...
              <div class="right">
                ...
                <p class="font36">海淀田园</p>
                <p class="right_time font14">开发周期：25个工作日</p>
                <p class="right_describe font16">通过活泼生动的地图展示海淀区的各个采摘园，通过点击可进入采摘园的内容介绍，可通过地图导航前往该采摘园，可收藏及评论采摘园</p>
              </div>
            </div>
          </div>
          <!-- 第二期 -->
    ...
    <div class="prd_sec_con2 app_consec">
      ...
      <div class="con2_module">
        <ul>
          <li>
            <p class="font18">摇一摇</p>
            <p class="font14">实现手机摇一摇的交互过程，结合功能和玩法吸引用户</p>
          </li>
          <li>
            <p class="font18">地图导航</p>
            <p class="font14">直接导航前往心仪的采摘园区，享受田园生活</p>
          </li>
          <li>
            <p class="font18">收藏园区</p>
            <p class="font14">将喜欢的园区添加到收藏，下次千万不必众里寻他</p>
          </li>
          <li>
            <p class="font18">园区展示</p>
            <p class="font14">园区内信息有序的展现到用户面前，更方便的挑选适合您的采摘园区</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="app_prd_con1">
      ...
      <div class="app_sec_box">
        ...
        <div :class="['app_box_fir', version == 1 ? 'hover' : '']">
          <h2>海淀田园</h2>
          <h4>开发周期：25个工作日</h4>
          <p>通过活泼生动的地图展示海淀区的各个采摘园，通过点击可进入采摘园的内容介绍，可通过地图导航前往该采摘园，可收藏及评论采摘园</p>
    ...
    <div class="app_prd_con2">
      ...
      <ul>
        <li>
          <h3><span></span>摇一摇</h3>
          <p>实现手机摇一摇的交互过程，结合功能和玩法吸引用户</p>
        </li>
        <li>
          <h3><span></span>地图导航</h3>
          <p>直接导航前往心仪的采摘园区，享受田园生活</p>
        </li>
        <li>
          <h3><span></span>收藏园区</h3>
          <p>将喜欢的园区添加到收藏，下次千万不必众里寻他</p>
        </li>
        <li>
          <h3><span></span>园区展示</h3>
          <p>园区内信息有序的展现到用户面前，更方便的挑选适合您的采摘园区</p>
        </li>
      </ul>
    </div>
    <!--内容三-->
    ...
    <div class="prd_sec_con5 app_consec">
      <div class="width">
        ...
        <div class="cengdaoyou clearfix">
          <div class="left">
            <div class="ceng_logo">
              <img src="http://pd10b0don.bkt.clouddn.com/HD_logo.png" class="left" />
              <div class="left qugou">
                <p class="font18">海淀田园</p>
                <p class="font14">海淀田园，一张地图带你玩遍海淀采摘园</p>
              </div>
            </div>
            <div class="ceng_character font14">
              北京市海淀区农村工作委员会（简称区农委）设立于2009年，挂海淀区动物卫生监督管理局牌子，与中共北京市海淀区农村工作委员会（简称区委农工委）合署办公。区农委是负责本区农村发展、农村经济工作和农业行业监督管理的政府工作部门，并承担海淀区社会主义新农村建设工作领导小组办公室职能。
            </div>
          </div>
...
export default {
  data () {
    return {
      ...
      appban: [
        {img1: 'http://pd10b0don.bkt.clouddn.com/HD_1.jpg'},
        {img1: 'http://pd10b0don.bkt.clouddn.com/HD_2.jpg'},
        {img1: 'http://pd10b0don.bkt.clouddn.com/HD_3.jpg'},
        {img1: 'http://pd10b0don.bkt.clouddn.com/HD_4.jpg'},
        {img1: 'http://pd10b0don.bkt.clouddn.com/HD_5.jpg'}
      ],
      swiperOption: {
