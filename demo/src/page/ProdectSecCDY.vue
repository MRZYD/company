  ...
  <div class="content">
          ...
          <div :class="['phase_box1 prd_box', tab == 1 ? 'hover' : '']">
            ...
            <div :class="['prd_box_app', type == 2 ? 'hover' : '']">
              ...
              <div class="right">
                ...
                <p class="font36">蹭导游服务平台</p>
                <p class="right_time font14">开发周期：30个工作日</p>
                <p class="right_describe font16">一个有故事的导游预约平台,游客可以通过蹭导游小程序进行预约私人导游和共享经济下的拼导游 (共享导游)</p>
              </div>
            </div>
          </div>
          <!-- 第二期 -->
    ...
    <div class="prd_sec_con2 app_consec">
      ...
      <div class="con2_module">
        <ul>
          <li>
            <p class="font18">拼导游</p>
            <p class="font14">游服务属于员似拼团一样,让更多人可以花少量的享受导游的乐趣</p>
          </li>
          <li>
            <p class="font18">包导游</p>
            <p class="font14">包导游服务类似于私人订制,让有更多需求的人可以享受到高级导游专属的服务</p>
          </li>
          <li>
            <p class="font18">免费听</p>
            <p class="font14">一个古城都有它历史悠久的文化古的,让我们大家免费聆听它的传奇故事</p>
          </li>
          <li>
            <p class="font18">分销商</p>
            <p class="font14">个需要长期发的产品都需要有合作伙伴的加入,那么分销商通过下线方式的合作引流</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="app_prd_con1">
      ...
      <div class="app_sec_box">
        ...
        <div :class="['app_box_fir', version == 1 ? 'hover' : '']">
          <h2>蹭导游服务平台</h2>
          <h4>开发周期：30个工作日</h4>
          <p>一个有故事的导游预约平台,游客可以通过蹭导游小程序进行预约私人导游和共享经济下的拼导游 (共享导游)</p>
    ...
    <div class="app_prd_con2">
      ...
      <ul>
        <li>
          <h3><span></span>拼导游</h3>
          <p>游服务属于员似拼团一样,让更多人可以花少量的享受导游的乐趣</p>
        </li>
        <li>
          <h3><span></span>包导游</h3>
          <p>包导游服务类似于私人订制,让有更多需求的人可以享受到高级导游专属的服务</p>
        </li>
        <li>
          <h3><span></span>免费听</h3>
          <p>一个古城都有它历史悠久的文化古的,让我们大家免费聆听它的传奇故事</p>
        </li>
        <li>
          <h3><span></span>分销商</h3>
          <p>个需要长期发的产品都需要有合作伙伴的加入,那么分销商通过下线方式的合作引流</p>
        </li>
      </ul>
    </div>
    <!--内容三-->
    ...
    <div class="prd_sec_con5 app_consec">
      <div class="width">
        ...
        <div class="cengdaoyou clearfix">
          <div class="left">
            <div class="ceng_logo">
              <img src="http://pd10b0don.bkt.clouddn.com/CDY_logo.png" class="left" />
              <div class="left qugou">
                <p class="font18">蹭导游服务平台</p>
                <p class="font14">一个有故事的导游预约平台</p>
              </div>
            </div>
            <div class="ceng_character font14">
              山西动的萤火虫网络科技有限公司成立于2017年1月17日旗下“蹭导游”平台将旅行中的服 务、社交、向导等功能巧妙融合,为用户提供简约、便捷的旅行增值服务。
              “蹭导游”是一个开放、自由、充满乐趣与惊喜的旅行服务平台。
              秉承 “蹭,是一种旅行乐趣”的创造理念,将产品的核心——导游服务进行创意升级,颠覆与创造 相结合，让旅行的过程充满想象力。
              新浪微博——@蹭导游        微信公众号——导游
            </div>
          </div>
...
export default {
  data() {
    return {
      ...
      appban: [
        { img1: "http://pd10b0don.bkt.clouddn.com/b1.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/cdy1.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/cdy2.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/cdy3.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/cdy4.jpg" }
      ],
      swiperOption: {
