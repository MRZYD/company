        ...
        <div class="con3_sec_li clearfix">
          <div class="con3_li_left">
            ...
            <ul class="clearfix">
              <li>
                <h4>在线预约房间</h4>
                <p>用户通过小程序在线选择要预约的房间，入住时间，交付定金及房费</p>
              </li>
              <li>
                <h4>智能取房卡省时入住</h4>
                <p>用户到店后，通过人脸识别或者微信扫码的方式，识别用户身份，智能匹配房卡，即可入住房间</p>
              </li>
              <li>
                <h4>用户数据打通</h4>
                <p>用户会员数据打通，根据用户消费习惯推送用户爱好的商场商品，同时享受积分优惠</p>
              </li>
              <li>
                <h4>在线退房节省时间</h4>
                <p>用户行程结束后，可在线退房，线下还卡，即退即走，消费详情在线推送，定金在线退还</p>
              </li>
            </ul>
          </div>
        ...
        <div class="con3_sec_li clearfix">
          ...
          <div class="con3_li_left">
            ...
            <ul class="clearfix">
              <li>
                <h4>线上引流到线下</h4>
                <p>现有公众号会员推送商城优惠活动信息，将线上用户引流到线下消费</p>
              </li>
              <li>
                <h4>线下引流到线上</h4>
                <p>线下设置小程序二维码展示，实现商场内导航，连接商场内WiFi等功能，同时能享受商城合作商户的优惠价格</p>
              </li>
              <li>
                <h4>内容吸引增加留存</h4>
                <p>通过对用户的消费习惯分析，公众号可精确为不同用户推送针对性的文章，增强用户忠诚度</p>
              </li>
              <li>
                <h4>用户来源统计</h4>
                <p>统计各渠道用户来源，为后续广告位设置提供数据资料，节省获客成本</p>
              </li>
            </ul>
          </div>
        </div>
        <div class="con3_sec_li clearfix">
          <div class="con3_li_left">
            ...
            <ul class="clearfix">
              <li>
                <h4>各大城市统一折扣</h4>
                <p>会员用户在换工作、出差、旅游等场景下，可享受全国统一的会员优惠价格，增强用户忠诚度</p>
              </li>
              <li>
                <h4>持续积分，优惠送不停</h4>
                <p>用户在集团旗下任意地区消费，使用任意的支付方式，都享受积分累加，可使用积分兑换更多的服务</p>
              </li>
              <li>
                <h4>针对性文章推送</h4>
                <p>根据用户行为习惯数据统计，可得出用户的喜好等个人消费习惯，可更有针对性的推送文章给客户</p>
              </li>
              <li>
                <h4>多业务联动，提供更好服务</h4>
                <p>集团自有资源完全整合，为用户提供一站式的集住宿、购物、餐饮、娱乐于一体的解决方案</p>
              </li>
            </ul>
          </div>
...
import '../../static/css/solusecond.css'
export default {
  data () {
    return {
