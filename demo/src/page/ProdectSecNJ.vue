  ...
  <div class="content">
          ...
          <div :class="['phase_box1 prd_box', tab == 1 ? 'hover' : '']">
            ...
            <div :class="['prd_box_app', type == 2 ? 'hover' : '']">
              ...
              <div class="right">
                ...
                <p class="font36">NJ English 官方平台</p>
                <p class="right_time font14">开发周期：45个工作日</p>
                <p class="right_describe font16">NJ English官方平台提供了全面的在线课程学习内容，并为提升学习积极性设置了每日读一句、早起团等特色功能，学习英语的道路上让你随时感受到老师的陪伴与鼓励。</p>
              </div>
            </div>
          </div>
          <!-- 第二期 -->
    ...
    <div class="prd_sec_con2 app_consec">
      ...
      <div class="con2_module">
        <ul>
          <li>
            <p class="font18">音频教学</p>
            <p class="font14">上传音频并形成系统课程，学生在学习一次后还可以重复收听，巩固知识点</p>
          </li>
          <li>
            <p class="font18">课程表</p>
            <p class="font14">用课程表的形式来通知报名的学生课程进度</p>
          </li>
          <li>
            <p class="font18">历史记录查看</p>
            <p class="font14">免费区板块以天为单位更新内容，历史记录查看可会看之前的学习内容</p>
          </li>
          <li>
            <p class="font18">视频教学</p>
            <p class="font14">上传视频教学内容，更丰富的教学场景更直观的教学触达</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="app_prd_con1">
      ...
      <div class="app_sec_box">
        ...
        <div :class="['app_box_fir', version == 1 ? 'hover' : '']">
          <h2>NJ English 官方平台</h2>
          <h4>开发周期：45个工作日</h4>
          <p>NJ English官方平台提供了全面的在线课程学习内容，并为提升学习积极性设置了每日读一句、早起团等特色功能，学习英语的道路上让你随时感受到老师的陪伴与鼓励。</p>
        ...
        <div :class="['app_box_fir', version == 2 ? 'hover' : '']">
          <h2>百会微题库</h2>
          <h4>开发周期：45个工作日</h4>
          <p>百会考试微题库，提供在线考试题库、在线做题、在线模拟测验服务，为考生充分利用碎片化的时间学习提供技术支持</p>
          <div class="app_box_fir_span">
            <span>微信小程序</span>
            <span>旅游</span>
            <span>游玩</span>
    ...
    <div class="app_prd_con2">
      ...
      <ul>
        <li>
          <h3><span></span>资讯导览</h3>
          <p>发布并查看发布的相关文章内容</p>
        </li>
        <li>
          <h3><span></span>活动报名</h3>
          <p>报名参加活动并统计报名人信息</p>
        </li>
        <li>
          <h3><span></span>黄页查询</h3>
          <p>快速查询附近的禁毒机构及联系方式</p>
        </li>
        <li>
          <h3><span></span>积分商城</h3>
          <p>通过积分商城来实现禁毒工具的派发，提升用户浏览积极性</p>
        </li>
      </ul>
    </div>
    <!--内容三-->
    ...
    <div class="prd_sec_con5 app_consec">
      <div class="width">
        ...
        <div class="cengdaoyou clearfix">
          <div class="left">
            <div class="ceng_logo">
              <img src="http://pd10b0don.bkt.clouddn.com/NJ_logo.png" class="left" />
              <div class="left qugou">
                <p class="font18">NJ  English官方平台</p>
                <p class="font14">NJ English官方平台，为少数民族的英语学习保驾护航</p>
              </div>
            </div>
            <div class="ceng_character font14">
              NJ English是“北京伟和思教育科技有限公司”旗下的在线英语教育平台。平台业务主要包括：实用英语教学、国内考试教学、出国留学考试教学等。
            </div>
          </div>
...
export default {
  data() {
    return {
      ...
      appban: [
        { img1: "http://pd10b0don.bkt.clouddn.com/NJ_1.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/NJ_2.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/NJ_3.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/NJ_4.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/NJ_5.jpg" }
      ],
      swiperOption: {
