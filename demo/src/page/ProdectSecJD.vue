  ...
  <div class="content">
          ...
          <div :class="['phase_box1 prd_box', tab == 1 ? 'hover' : '']">
            ...
            <div :class="['prd_box_app', type == 2 ? 'hover' : '']">
              ...
              <div class="right">
                ...
                <p class="font36">禁毒时刻</p>
                <p class="right_time font14">开发周期：30个工作日</p>
                <p class="right_describe font16">禁毒时刻提供了禁毒志愿者交流的平台，发布禁毒相关的文章内容，以期让更多的人参与到禁毒的事业中，远离毒品，人人有责！</p>
              </div>
            </div>
          </div>
          <!-- 第二期 -->
    ...
    <div class="prd_sec_con2 app_consec">
      ...
      <div class="con2_module">
        <ul>
          <li>
            <p class="font18">资讯导览</p>
            <p class="font14">发布并查看发布的相关文章内容</p>
          </li>
          <li>
            <p class="font18">活动报名</p>
            <p class="font14">报名参加活动并统计报名人信息</p>
          </li>
          <li>
            <p class="font18">黄页查询</p>
            <p class="font14">快速查询附近的禁毒机构及联系方式</p>
          </li>
          <li>
            <p class="font18">积分商城</p>
            <p class="font14">通过积分商城来实现禁毒工具的派发，提升用户浏览积极性</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="app_prd_con1">
      ...
      <div class="app_sec_box">
        ...
        <div :class="['app_box_fir', version == 1 ? 'hover' : '']">
          <h2>禁毒时刻</h2>
          <h4>开发周期：30个工作日</h4>
          <p>禁毒时刻提供了禁毒志愿者交流的平台，发布禁毒相关的文章内容，以期让更多的人参与到禁毒的事业中，远离毒品，人人有责！</p>
    ...
    <div class="prd_sec_con5 app_consec">
      <div class="width">
        ...
        <div class="cengdaoyou clearfix">
          <div class="left">
            <div class="ceng_logo">
              <img src="http://pd10b0don.bkt.clouddn.com/JD_logo.png" class="left" />
              <div class="left qugou">
                <p class="font18">禁毒时刻</p>
                <p class="font14">禁毒时刻，远离毒品，人人有责</p>
              </div>
            </div>
            <div class="ceng_character font14">
              禁毒时刻是与禁毒相关小程序，具有强烈的禁毒学术氛围。不仅方便了禁毒志愿者和群众参加禁毒宣传活动，同时能够使禁毒志愿者和群众通过最便携的方式了解禁毒相关知识。
            </div>
          </div>
...
export default {
  data() {
    return {
      ...
      appban: [
        { img1: "http://pd10b0don.bkt.clouddn.com/JD_1.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/JD_2.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/JD_3.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/JD_4.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/JD_5.jpg" }
      ],
      swiperOption: {
