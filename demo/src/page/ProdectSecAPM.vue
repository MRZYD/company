  ...
  <div class="content">
        ...
        <div class="phase_box">
          ...
          <div :class="['phase_box1 prd_box', tab == 1 ? 'hover' : '']">
            ...
            <div :class="['prd_box_app', type == 2 ? 'hover' : '']">
              ...
              <div class="right">
                ...
                <p class="font36">APMMonaco V1.0</p>
                <p class="right_time font14">开发周期：15个工作日</p>
                <p class="right_describe font16">提供在线预览，在线选购，在线支付等商城基本功能，为后期迭代打下基础。</p>
              </div>
            </div>
          </div>
          <!-- 第二期 -->
          <div :class="['phase_box2 prd_box', tab == 2 ? 'hover' : '']">
            ...
            <div :class="['prd_box_app', type == 2 ? 'hover' : '']">
              ...
              <div class="right">
                <p class="right_title font14">微信小程序</p>
                <p class="font36">APMMonaco V2.0</p>
                <p class="right_time font14">开发周期：30个工作日</p>
                <p class="right_describe font16">APM情人节活动，生成并领取专属的APM线下优惠卡券，充分打通线上线下的连接。</p>
              </div>
            </div>
          </div>
    ...
    <div class="prd_sec_con2 app_consec">
      ...
      <div class="con2_module">
        <ul>
          <li>
            <p class="font18">商品分类</p>
            <p class="font14">商品按照不同分类展示，可后台自定义分类内容</p>
          </li>
          <li>
            <p class="font18">商品下单</p>
            <p class="font14">在线下单购买，订单同步到系统后台</p>
          </li>
          <li>
            <p class="font18">物流查询</p>
            <p class="font14">调用第三方的物流查询接口，实时查询物流状态</p>
          </li>
          <li>
            <p class="font18">订单管理</p>
            <p class="font14">查看历史订单，了解消费详情</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="app_prd_con1">
      ...
      <div class="app_sec_box">
        ...
        <div :class="['app_box_fir', version == 1 ? 'hover' : '']">
          <h2>APMMonaco V1.0</h2>
          <h4>开发周期：15个工作日</h4>
          <p>提供在线预览，在线选购，在线支付等商城基本功能，为后期迭代打下基础。</p>
        ...
        <div :class="['app_box_fir', version == 2 ? 'hover' : '']">
          <h2>APMMonaco V2.0</h2>
          <h4>开发周期：30个工作日</h4>
          <p>APM情人节活动，生成并领取专属的APM线下优惠卡券，充分打通线上线下的连接。</p>
          <div class="app_box_fir_span">
            <span>微信小程序</span>
            <span>旅游</span>
            <span>游玩</span>
    ...
    <div class="app_prd_con2">
      ...
      <ul>
        <li>
          <h3><span></span>商品分类</h3>
          <p>商品按照不同分类展示，可后台自定义分类内容</p>
        </li>
        <li>
          <h3><span></span>商品下单</h3>
          <p>在线下单购买，订单同步到系统后台</p>
        </li>
        <li>
          <h3><span></span>物流查询</h3>
          <p>调用第三方的物流查询接口，实时查询物流状态</p>
        </li>
        <li>
    ...
    <div class="prd_sec_con5 app_consec">
      <div class="width">
        ...
        <div class="cengdaoyou clearfix">
          <div class="left">
            <div class="ceng_logo">
              <img src="http://pd10b0don.bkt.clouddn.com/APM_logo.png" class="left" />
              <div class="left qugou">
                <p class="font18">APM Monaco</p>
                <p class="font14">APM Monaco，潮流珠宝销售品牌</p>
              </div>
            </div>
            <div class="ceng_character font14">
              1982年创办的时尚首饰品牌，传承30年的精湛的珠宝制作传统和工艺，不仅令品牌家喻户晓，更是现代、常青、永远走在潮流前线的珠宝品牌。
            </div>
          </div>
...
export default {
  data() {
    return {
      ...
      appban: [
        { img1: "http://pd10b0don.bkt.clouddn.com/APM_1.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/APM_2.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/APM_3.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/APM_4.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/APM_5.jpg" }
      ],
      swiperOption: {
