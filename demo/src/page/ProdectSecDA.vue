  ...
  <div class="content">
          ...
          <div :class="['phase_box1 prd_box', tab == 1 ? 'hover' : '']">
            ...
            <div :class="['prd_box_app', type == 2 ? 'hover' : '']">
              ...
              <div class="right">
                ...
                <p class="font36">对啊课堂</p>
                <p class="right_time font14">开发周期：45个工作日</p>
                <p class="right_describe font16">在这里，重塑职业未来</p>
              </div>
            </div>
          </div>
          <!-- 第二期 -->
    ...
    <div class="prd_sec_con2 app_consec">
      ...
      <div class="con2_module">
        <ul>
          <li>
            <p class="font18">分类题库</p>
            <p class="font14">在这里，可以找到和你职业考试相关的题库内容</p>
          </li>
          <li>
            <p class="font18">模拟考试</p>
            <p class="font14">完全模拟考场答题，在有限的时间里答题，并在交卷后给出考试成绩和答案解析</p>
          </li>
          <li>
            <p class="font18">错题库</p>
            <p class="font14">自动记录错题，每一道错题，都是成长的关键</p>
          </li>
          <li>
            <p class="font18">视频课程</p>
            <p class="font14">在线的视频课程助你在职业考试道路上一臂之力</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="app_prd_con2">
      ...
      <ul>
        <li>
          <h3><span></span>分类题库</h3>
          <p>在这里，可以找到和你职业考试相关的题库内容</p>
        </li>
        <li>
          <h3><span></span>模拟考试</h3>
          <p>完全模拟考场答题，在有限的时间里答题，并在交卷后给出考试成绩和答案解析</p>
        </li>
        <li>
          <h3><span></span>错题库</h3>
          <p>自动记录错题，每一道错题，都是成长的关键</p>
        </li>
        <li>
          <h3><span></span>视频课程</h3>
          <p>在线的视频课程助你在职业考试道路上一臂之力</p>
        </li>
      </ul>
    </div>
    <!--内容三-->
    ...
    <div class="prd_sec_con5 app_consec">
      <div class="width">
        ...
        <div class="cengdaoyou clearfix">
          <div class="left">
            <div class="ceng_logo">
              <img src="http://pd10b0don.bkt.clouddn.com/DA_logo.png" class="left" />
              <div class="left qugou">
                <p class="font18">对啊课堂</p>
                <p class="font14">对啊课堂，在这里，重塑职业未来</p>
              </div>
            </div>
            <div class="ceng_character font14">
              对啊网|中国领先的移动互联网职业教育企业。提供涵盖会计、教师、金融、公务员、建造师、人力资源等职业教育及外语、学历类教育的免费视频课程，在线直播课程，在线题库，论坛社区。致力于帮助每一位年轻人通过职业学习，重塑职业未来，成就职业梦想！
            </div>
          </div>
...
export default {
  data() {
    return {
      ...
      appban: [
        { img1: "http://pd10b0don.bkt.clouddn.com/DA_1.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/DA_2.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/DA_3.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/DA_4.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/DA_5.jpg" }
      ],
      swiperOption: {
