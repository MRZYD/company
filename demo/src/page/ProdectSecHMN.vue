  ...
  <div class="content">
          ...
          <div :class="['phase_box1 prd_box', tab == 1 ? 'hover' : '']">
            ...
            <div :class="['prd_box_app', type == 2 ? 'hover' : '']">
              ...
              <div class="right">
                ...
                <p class="font36">和美尼音乐教育</p>
                <p class="right_time font14">开发周期：30个工作日</p>
                <p class="right_describe font16">为学生提供在线的音乐教育课程，在线导航方便找到学校，积分系统兑换学校特色课程的服务。</p>
              </div>
            </div>
          </div>
          <!-- 第二期 -->
      ...
      <div class="con2_module">
        <ul>
          <li>
            ...
            <p class="font14">方便快捷的找到校区并导航前往</p>
          </li>
          <li>
            <p class="font18">积分系统</p>
            <p class="font14">完善的积分获得和消除系统，实现用户与平台的紧密结合</p>
          </li>
          <li>
            <p class="font18">课程预约</p>
            <p class="font14">在线预约课程，线下体验</p>
          </li>
          <li>
            <p class="font18">课程视频</p>
            <p class="font14">更直观的方式让用户感受到平台的实力和模式</p>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="app_prd_con1">
      ...
      <div class="app_sec_box">
        ...
        <div :class="['app_box_fir', version == 1 ? 'hover' : '']">
          <h2>和美尼音乐教育</h2>
          <h4>开发周期：30个工作日</h4>
          <p>为学生提供在线的音乐教育课程，在线导航方便找到学校，积分系统兑换学校特色课程的服务。</p>
    ...
    <div class="app_prd_con2">
      ...
      <ul>
        ...
        <li>
          <h3><span></span>积分系统</h3>
          <p>完善的积分获得和消除系统，实现用户与平台的紧密结合</p>
        </li>
        <li>
          <h3><span></span>课程预约</h3>
          <p>在线预约课程，线下体验</p>
        </li>
        <li>
          <h3><span></span>课程视频</h3>
          <p>更直观的方式让用户感受到平台的实力和模式</p>
        </li>
      </ul>
    </div>
    <!--内容三-->
    ...
    <div class="prd_sec_con5 app_consec">
      <div class="width">
        ...
        <div class="cengdaoyou clearfix">
          <div class="left">
            <div class="ceng_logo">
              <img src="http://pd10b0don.bkt.clouddn.com/HMN_logo.png" class="left" />
              <div class="left qugou">
                <p class="font18">和美尼音乐教育</p>
                <p class="font14">和美尼音乐启蒙教育致力于研发最具趣味性的0—12岁的多人（6—12人）艺术类高效小组课程</p>
              </div>
            </div>
            <div class="ceng_character font14">
              Harmolody-和美尼艺术教育致力于研发0-12岁的多人（6-12人）艺术类小组课程。从长线的音乐素养和短线的结果输出之间找到最为科学的平衡点，通过先进的教育法以及科技设备的辅助，给孩子提供最具趣味性的高效率音乐课程。另一方面通过建立自媒体服务，以向线下的b端商家提供包含课程、教师、设备、招生渠道等打包性服务，以期更好地服务广大线下中小型培训机构。
            </div>
          </div>
...
export default {
  data() {
    return {
      ...
      appban: [
        { img1: "http://pd10b0don.bkt.clouddn.com/HMN_1.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/HMN_2.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/HMN_3.jpg" },
        { img1: "http://pd10b0don.bkt.clouddn.com/HMN_4.jpg" }
      ],
      swiperOption: {
